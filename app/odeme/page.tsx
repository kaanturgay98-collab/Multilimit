    ...
    <main className="min-h-screen bg-background pt-24 pb-16">
      <div className="container mx-auto px-4 max-w-3xl">
        <div className="rounded-3xl border border-border bg-card p-8 md:p-10 text-center">
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Siteden Siparis Alinmiyor</h1>
          <p className="text-muted-foreground mb-8">
            Bu web sitesi artik e-ticaret/odeme islemi yapmamaktadir. Siparislerin tumu yalnizca Trendyol
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Button asChild size="lg" variant="outline">
              <Link href="/urun">Urunu Incele</Link>
            </Button>
          </div>
        </div>
      </div>
